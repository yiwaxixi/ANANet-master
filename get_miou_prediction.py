...
image_ids = open(r"./VOCdevkit/VOC2007/ImageSets/Segmentation/val.txt", 'r').read().splitlines()  # 加载验证集的txt文件
...
for image_id in image_ids:
    ...
    image = ZYWnet.detect_image(image)
